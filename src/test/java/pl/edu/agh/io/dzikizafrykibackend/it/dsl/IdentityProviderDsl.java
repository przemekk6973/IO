...
public class IdentityProviderDsl {
    ...
    public IdentityProviderDsl(UserRepository userRepository, CourseRepository courseRepository, UserPreferencesRepository userPreferencesRepository, RetrofitClient retrofitClient) {
